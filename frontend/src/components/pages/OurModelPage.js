        ...
        <div className="ourModelPage">
            ...
            <div className="ourModelTextDisplayContainer">
                <div className="ourModelTextDisplay">
                    <div className='ourModelBodyTitle'> Introduction </div>
                    ...
                    <img src={KERAS} alt="Dev" className='centerAlignImage'/>
                    ...
                    <img src={PYTORCH} alt="Dev" className='centerAlignImage'/>
                    ...
                    <img src={BERT} alt="Dev" className='centerAlignImage'/>
                    ...
                    <img src={WEKA} alt="Dev" className='centerAlignImage'/>
                    <p>For our next approach, we found Weka 3: Machine Learning Software in Java built by the University of Waikato, 
                        ...
                        this idea. </p>
                    <img src={NYCKEL} alt="Dev" className='centerAlignImage'/>
                    ...
                    <div className='ourModelBodyTitle'> Conclusion </div>
